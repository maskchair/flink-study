...
public abstract class TaxiRideTestBase<OUT> {
	public static class TestRideSource extends org.apache.flink.training.exercises.testing.TestSource<TaxiRide> implements ResultTypeQueryable<TaxiRide> {
	...
	public static class TestFareSource extends org.apache.flink.training.exercises.testing.TestSource<TaxiFare> implements ResultTypeQueryable<TaxiFare> {
	...
	public static class TestStringSource extends org.apache.flink.training.exercises.testing.TestSource<String> implements ResultTypeQueryable<String> {
